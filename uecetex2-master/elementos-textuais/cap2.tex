...
\begin{table}[h!]   
    \centering
    \Caption{\label{tab:tbl2} Vantagens e desvantagens do ambiente Java.}
    \UECEtab{}{
        \begin{tabular}{| l p{5cm} | l p{5cm}|}
            \toprule
                Vantagens & Desvantagens \\
            \midrule \midrule
                Mais opções de softwares para serem utilizados e maior flexibilidade na montagem do ambiente. & Necessário adiquirir softwares de várias fontes. \\
                Tamanho em \textit{magabytes} do software necessário menor. & O desenvolvedor deve estudar cada componente de seu ambiente de desenvolvimento para entender como eles interagem entre sí. \\
            \bottomrule
        \end{tabular}
    }{
