...
\figura{gradleproject1.png}{Criando um projeto do \textit{Gradle}}{fig:gradleproject}

É criado um projeto com a estrutura mostrada na Figura~\ref{fig:gradletree}.

\figura{gradleproject2.png}{Estrutura inicial de um projeto do \textit{Gradle}}{fig:gradletree}
...
\figura{prrojetocomweninf.png}{Estrutura do projeto com a pasta \textit{WebContent}}{fig:12}
...
\figura{gradlecommand.png}{\textit{Gradle Task Quick Launcher}}{fig:13}
...
\figura{tomcatproject.png}{Adicionando um projeto \textit{web} ao \textit{Tomcat}}{fig:14}
...
\figura{refreshdependencies.png}{Atualizando dependências de um projeto \textit{Gradle}}{fig:15}
...
\figura{vsnewproject.png}{Criando um novo projeto no \textit{Visual Studio Community 2013}}{fig:17}
...
\figura{vsnewproject2.png}{Opções de um novo projeto \textit{web} no \textit{Visual Studio}}{fig:18}
...
\figura{19.png}{Estrutura de um projeto \textit{ASP.NET MVC 5}}{fig:19}
...
\figura{20.png}{Acessando o console do \textit{NuGet}}{fig:20}
...
\figura{21.png}{Console do \textit{NuGet}}{fig:21}
...
\figura{23.png}{Arquivo adicional do \textit{Ninject}}{fig:23}
